            ...
            <div class="ass1-section__post-detail" v-if="getDataPostDetail && getDataPostDetail.post">
                <div class="ass1-section">
                    ...
                    <div class="list-categories">
                        ...
                        <ul>
                            <li v-for="item in getDataPostDetail.category" v-bind:key="item.TAG_ID">
                ...
                <post-comment-add @handleChangeComments='handleChangeComments'/>

                <post-comments :listComment='listComment'/>
            </div>
        </div>
        <div class="col-lg-4">
            <sidebar />
...
export default {
           ...
           this.postId = to.params.id;
            this.getPostDetailById(this.postId).then(res => {
                if(!res.ok) {
                    ...
                    this.listComment = res.listComment;
                }
            })
        }
    },
    ...
    computed: {
        ...mapGetters(['getDataPostDetail','currentUser'])
    },
    created() {
    ...
    methods: {
        ...
        handleChangeComments(data){
            let commentItem = {
                ...data,
                fullname:this.currentUser.fullname,
                profilepicture:this.currentUser.profilepicture
            };
            this.listComment.push(commentItem);
